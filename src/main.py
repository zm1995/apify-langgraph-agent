...
async def main() -> None:
    ...
    async with Actor:
        ...
        openai_api_key = actor_input.get('openaiApiKey') or os.getenv('OPENAI_API_KEY')
        if not openai_api_key:
            msg = 'Missing OpenAI API key! Please provide it in the input as "openaiApiKey" or set it as environment variable OPENAI_API_KEY.'
            Actor.log.error(msg)
            raise ValueError(msg)
        ...
        tools = [tool_scrape_youtube_30_posts]
